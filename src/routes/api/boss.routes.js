...
const { getAllUsers, getUsersById, createUser, updateUser, deleteUser, getAllWarehouse, createWarehouse, getWarehouseById, updateWarehouse, deleteWarehouse, getAvailableTrucks, getTruckById, getAvailableWarehouse } = require('../../controllers/boss.controller');
...
router.get('/available-warehouse', getAvailableWarehouse)
